...
- `src/cursor-ripgrep-path.ts` owns bundled Cursor SDK platform ripgrep and tree-sitter vendor resolution and local-agent environment initialization (`CURSOR_RIPGREP_PATH`, `CURSOR_TREE_SITTER_VENDOR_DIR`).
